...
GOOGLE_DEVELOPER_TOKEN = os.environ.get("GOOGLE_ADS_DEVELOPER_TOKEN", os.environ.get("GOOGLE_DEVELOPER_TOKEN", "xr00fFrU4qlg4WlDlkIVfA"))
GOOGLE_CUSTOMER_ID    = os.environ.get("GOOGLE_ADS_CUSTOMER_ID", os.environ.get("GOOGLE_CUSTOMER_ID", ""))
GOOGLE_MCC_ID         = os.environ.get("GOOGLE_ADS_LOGIN_CUSTOMER_ID", os.environ.get("GOOGLE_MCC_ID", "6359594317"))
